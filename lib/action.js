...
function runAction(configurationProvider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new VersionResult_1.VersionResult(versionInfo.major, versionInfo.minor, versionInfo.patch, versionInfo.preReleaseType, versionInfo.preReleaseBuild, versionInfo.increment, versionInfo.type, versionFormatter.Format(versionInfo), tagFormatter.Format(versionInfo), versionInfo.changed, versionInfo.isTagged, userFormatter.Format("author", authors), currentCommit, lastRelease.hash, lastReleaseVersion, debugManager.getDebugOutput());
    });
}
