...
function setOutput(versionResult) {
    const { major, minor, patch, preReleaseType, preReleaseBuild, increment, versionType, formattedVersion, versionTag, changed, isTagged, authors, currentCommit, previousCommit, previousVersion, debugOutput, } = versionResult;
    ...
    core.setOutput("pre_release_type", preReleaseType === null || preReleaseType === void 0 ? void 0 : preReleaseType.toString());
    core.setOutput("pre_release_build", preReleaseBuild === null || preReleaseBuild === void 0 ? void 0 : preReleaseBuild.toString());
    core.setOutput("patch", patch.toString());
