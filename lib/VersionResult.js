...
class VersionResult {
     ...
     */
    constructor(major, minor, patch, preReleaseType, preReleaseBuild, increment, versionType, formattedVersion, versionTag, changed, isTagged, authors, currentCommit, previousCommit, previousVersion, changedFiles, debugOutput) {
        this.major = major;
        this.minor = minor;
        this.patch = patch;
