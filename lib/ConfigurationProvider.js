...
class ConfigurationProvider {
    ...
    GetLastReleaseResolver() {
        return new DefaultLastReleaseResolver_1.DefaultLastReleaseResolver();
    }
    GetCommitsProvider() {
    ...
    GetChangedFiles() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const octokit = new octokit_1.Octokit({ auth: this.config.personalAccessToken });
            const response = yield octokit.rest.repos.compareCommits(Object.assign({ base: github.context.payload.before, head: github.context.payload.after }, github.context.repo));
            const allChangedFiles = (_b = (_a = response.data.files) === null || _a === void 0 ? void 0 : _a.map(x => x.filename)) !== null && _b !== void 0 ? _b : [];
            const matched = (0, micromatch_1.default)(allChangedFiles, this.config.changePath.split(' ').filter(x => x !== ''));
            return matched;
        });
    }
}
