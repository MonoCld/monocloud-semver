...
class ReleaseInformation {
     ...
     */
    constructor(major, minor, patch, preReleaseType, preReleaseBuild, hash, currentMajor, currentMinor, currentPatch, currentPreReleaseType, currentPreReleaseBuild, isTagged) {
        this.major = major;
        this.minor = minor;
        this.patch = patch;
        ...
        this.currentPreReleaseType = currentPreReleaseType;
        this.currentPreReleaseBuild = currentPreReleaseBuild;
