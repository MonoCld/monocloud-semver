    ...
    ResolveAsync(current, tagFormatter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tag === '') {
                ...
                return new ReleaseInformation_1.ReleaseInformation(major, minor, patch, preReleaseType, preReleaseBuild, '', currentMajor, currentMinor, currentPatch, currentPreReleaseType, currentPreReleaseBuild, isTagged);
            }
            ...
            return new ReleaseInformation_1.ReleaseInformation(major, minor, patch, preReleaseType, preReleaseBuild, root.trim(), currentMajor, currentMinor, currentPatch, currentPreReleaseType, currentPreReleaseBuild, isTagged);
        });
    }
}
